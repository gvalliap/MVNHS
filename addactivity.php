                ...
                <form method="post">
                    ...
                    <div class="row">
                        <div class="input-field col s12 l8">
                            <textarea id="description" value="<?=$description; ?>" name="description" class="materialize-textarea"></textarea>
                            <label for="description">Description</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s12 l8">
                            <textarea id="location" value="<?=$location; ?>" name="location" class="materialize-textarea"></textarea>
